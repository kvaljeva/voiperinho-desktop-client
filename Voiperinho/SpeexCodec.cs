...
{
    [Export(typeof(INetworkCodec))]
    class NarrowBandSpeexCodec : SpeexCodec
    {
    ...
    [Export(typeof(INetworkCodec))]
    class WideBandSpeexCodec : SpeexCodec
    {
    ...
    [Export(typeof(INetworkCodec))]
    class UltraWideBandSpeexCodec : SpeexCodec
    {
    ...
    class SpeexCodec : INetworkCodec
    {
        ...
        public SpeexCodec(BandMode bandMode, int sampleRate, string description)
        {
